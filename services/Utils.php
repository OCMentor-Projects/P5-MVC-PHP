...
class Utils
{
    ...
    /**
     * Cette méthode permet de générer une URL à partir d'un nom de route et de paramètres.
    ...
    public static function sortDirectionIndicator(string $sortDirection): void
    {
